...
std::string CallPaillier::paillierAdd(const std::string &cipher1,
  ...
  if (cipher1.length() != cipher2.length() ||
      cipher1.substr(0, 4) != cipher2.substr(0, 4)) {
...
CallPaillier::paillierAdd(const std::vector<unsigned char> &cipher1,
